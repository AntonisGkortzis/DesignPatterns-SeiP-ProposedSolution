...
public interface MetricsExporter {
	...
	/*
	 * public void writeFile(String outputType, Map<String, Integer> metrics, String
	 * filepath) { if (outputType.equals("csv")) { writeCsv(metrics, filepath); }
	 * else if (outputType.equals("json")) { writeJson(metrics, filepath); } else {
	 * throw new IllegalArgumentException("Unknown type : " + outputType); } }
	 * 
	 * private void writeCsv(Map<String, Integer> metrics, String filepath) { File
	 * outputFile = new File(filepath + ".csv"); StringBuilder metricsNames = new
	 * StringBuilder(); StringBuilder metricsValues = new StringBuilder();
	 * 
	 ...
	 * writer.close(); System.out.println("Metrics saved in " +
	 ...
	 * Functionality not implemented yet // No need to implement it for the
	 * assignment }
	 */
